...
if(!isSupportFileApi()||typeof(Storage) == "undefined") {
  ...
  <div id="homeHeader"><a href="index.php"><img src="img/logo.png" alt="BlueCypher"></a></div>
   <div id="containerLoginpage">
    <div class="container theme-showcase">
       <div id="bcypherPreview">
           <h1><b>BLUE</b>CYPHER</h1>
           <h2>'Simply the best there is'</h2>
           <img src="img/lockicongrt.png" alt="Lock icon">
       </div>
        ...
        <button class="btn btn-sm btn-default" type="button" onClick="window.location.href='signup.php';" >Sign Up</button>&nbsp;
